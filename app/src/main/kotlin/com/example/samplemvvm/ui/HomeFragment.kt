...
class HomeFragment : Fragment() {
    ...
    private val viewModel: HomeViewModel by activityViewModels() { HomeViewModel.Factory((requireActivity().application as App).appContainer.repoRepository, Dispatchers.Main) }
